...
/**
 * @class BeaconsMapRookieLeagueController
 * @brief Manages and renders the game map and beacon animation.
 */
export default class BeaconsMapRookieLeagueController extends CanvasController {
  ...
  setup() {
    ...
    this._p5Instance.frameRate(BeaconsMapRookieLeagueController.PULSE_SPEED);
  }
  ...
  #drawMap() {
    ...
    this._p5Instance.strokeWeight(
      BeaconsMapRookieLeagueController.STROKE_WEIGHT,
    );
    this._p5Instance.stroke("white");
    ...
    this._p5Instance.fill(
      ...
      255,
      255 *
        (BeaconsMapRookieLeagueController.MAX_PULSE_SCALE - this._pulseScale),
    );
  ...
  #updatePulseEffects() {
    ...
    if (this._pulseScale >= BeaconsMapRookieLeagueController.MAX_PULSE_SCALE) {
      this._pulseScale = 1;
    }
  }
}
